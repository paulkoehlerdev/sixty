...
import {Branch, Location, Offer, SearchRequest, SelectedLocation} from "./types";
...
export async function getSuggestedLocations(query: string) {
    ...
    return suggestedLocations.suggestions.map(suggestion => suggestion.location);
}

export function selectLocation(branch: Branch): Promise<SelectedLocation> {
    return doGrpcRequest<SelectedLocation>(
    ...
    return (await doGrpcRequest<{
        ...
        "com.sixt.service.rent_booking.api.BookingService/GetOfferRecommendationsV2", {
            ...
            "trip_spec": {
                ...
                "pickup_location_selection_id": req.pickup_location.location_selection_id,
                "return_location_selection_id": req.return_location.location_selection_id,
                "point_of_sale": "DE",
