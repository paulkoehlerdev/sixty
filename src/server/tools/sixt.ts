...
import { z } from "zod";
import { getBookingForOffer, getOfferRecommendations, getSuggestedLocations, selectLocation } from "../../lib/sixt/api";
import type { AddOns, Branch, CarInfo, Distance, Image, MileagePlan, Positon, Price } from "../../lib/sixt/types.ts";
